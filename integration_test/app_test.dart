...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      /* Because the `MyApp` widget has only one FloatingActionButton
         we can find the the widget that needs to be tapped by its type.    */

      await tester.tap(find.byType(FloatingActionButton));
      // Wait for any animations to happen
